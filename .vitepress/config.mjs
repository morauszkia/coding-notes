            ...
            [pythonPath]: [
                {
                    ...
                    items: [
                        ...
                        { text: "Strings", link: `${pythonPath}/strings` },
                        { text: "Numbers", link: `${pythonPath}/numbers` },
                        { text: "Lists", link: `${pythonPath}/lists` },
                        { text: "Tuples", link: `${pythonPath}/tuples` },
                        {
            ...
            [tsPath]: [
                {
                    ...
                    items: [
                        ...
                        {
                            text: "Type Narrowing",
                            link: `${tsPath}/type-narrowing`,
                        },
                        {
                            text: "Type Assertion",
                            link: `${tsPath}/type-assertion`,
                        },
                        { text: "Classes", link: `${tsPath}/classes` },
                        {
                            text: "Utility Types",
                            link: `${tsPath}/utility-types`,
                        },
            ...
            [goPath]: [
                {
                    ...
                    items: [
                        ...
                        { text: "Limitations", link: `${goPath}/limitations` },
                    ],
                },
                mainNav,
            ],
